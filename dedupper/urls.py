...
urlpatterns = [
    ...
    path('crm/', views.crm, name='crm'),  # figure out url reverse
    path('edit/', views.edit, name='edit'),  # figure out url reverse
    path('indust/', views.industries, name='indust'),  # figure out url reverse
