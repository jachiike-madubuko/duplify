...
a._dom.close=c('<button class="close close-button">&times;</div>');a._dom.close.click(function(){a._dte.close("icon")});return a},open:function(f,d,g){a._shown?g&&g():(a._dte=f,a._shown=!0,f=a._dom.content,f.children().detach(),f.append(d),f.prepend(a._dom.close),c(a._dom.content).one("opened.fndtn.reveal",function(){g&&g()}).one("closed.fndtn.reveal",function(){a._shown=!1}),b.Foundation&&b.Foundation.Reveal?(a._reveal||(a._reveal=new b.Foundation.Reveal(a._dom.content,{closeOnClick:!1})),a._reveal.open()):
