...
footer:{wrapper:"DTE_Footer modal-footer"},form:{tag:"form-horizontal",button:"btn btn-default"},field:{wrapper:"DTE_Field form-group row",label:"col-lg-4 col-form-label",input:"col-lg-8",error:"error is-invalid","msg-labelInfo":"form-text text-secondary","msg-info":"form-text text-secondary","msg-message":"form-text text-secondary","msg-error":"form-text text-danger",multiValue:"card multi-value",multiInfo:"small",multiRestore:"card multi-restore"}});a.extend(!0,b.ext.buttons,{create:{formButtons:{className:"btn-primary"}},
edit:{formButtons:{className:"btn-primary"}},remove:{formButtons:{className:"btn-danger"}}});b.Editor.display.bootstrap=a.extend(!0,{},b.Editor.models.displayController,{init:function(b){c._dom.content||(c._dom.content=a('<div class="modal fade DTED"><div class="modal-dialog"><div class="modal-content"/></div></div>'),c._dom.close=a('<button class="close">&times;</div>'),c._dom.close.click(function(){c._dte.close("icon")}),a(d).on("click","div.modal",function(b){a(b.target).hasClass("modal")&&c._shown&&
c._dte.background()}));b.on("displayOrder.dtebs",function(c,d,e,f){a.each(b.s.fields,function(c,b){a("input:not([type=checkbox]):not([type=radio]), select, textarea",b.node()).addClass("form-control")})});return c},open:function(b,d,e){c._shown?e&&e():(c._dte=b,c._shown=!0,c._fullyDisplayed=!1,b=c._dom.content.find("div.modal-content"),b.children().detach(),b.append(d),a("div.modal-header",d).append(c._dom.close),a(c._dom.content).one("shown.bs.modal",function(){c._dte.s.setFocus&&c._dte.s.setFocus.focus();
c._fullyDisplayed=!0;e&&e()}).one("hidden",function(){c._shown=!1}).appendTo("body").modal({backdrop:"static",keyboard:!1}))},close:function(b,d){if(c._shown)if(c._fullyDisplayed)a(c._dom.content).one("hidden.bs.modal",function(){a(this).detach()}).modal("hide"),c._dte=b,c._shown=!1,c._fullyDisplayed=!1,d&&d();else a(c._dom.content).one("shown.bs.modal",function(){c.close(b,d)});else d&&d()},node:function(a){return c._dom.content[0]},_shown:!1,_dte:null,_dom:{}});var c=b.Editor.display.bootstrap;
return b.Editor});
